...
gulp.task('vendors-js', function() {
   return streamqueue({ objectMode: true },
    ...
    gulp.src(`${dirs.src}/js/vendors/jquery.min.js`), 
    gulp.src(`${dirs.src}/js/vendors/jquery.magnific-popup.js`),
    gulp.src(`${dirs.src}/js/vendors/easings.js`),
    gulp.src(`${dirs.src}/js/vendors/scrolloverflow.js`),
    gulp.src(`${dirs.src}/js/vendors/fullpage.js`),
    gulp.src(`${dirs.src}/js/vendors/fullpage.extensions.min.js`),
    ...
    gulp.src(`${dirs.src}/js/vendors/greensock/TweenMax.min.js`),
    gulp.src(`${dirs.src}/js/vendors/scrollmagic/ScrollMagic.min.js`),
    gulp.src(`${dirs.src}/js/vendors/scrollmagic/plugins/animation.gsap.min.js`),
    //gulp.src(`${dirs.src}/js/vendors/slick.min.js`),
    //gulp.src(`${dirs.src}/js/vendors/smooth-scroll.js`),
    gulp.src(`${dirs.src}/js/vendors/jquery.nicescroll.min.js`)
...
gulp.task("serve", function(){
  ...
  gulp.watch(`${dirs.src}/js/components/**/*.js`, ["component-js"]);
  gulp.watch(paths.js.watch, ["main-js"]);
  gulp.watch(paths.jsPartials.watch,["main-js"])
